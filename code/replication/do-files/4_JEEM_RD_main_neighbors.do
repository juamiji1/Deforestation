...
gen diff_ilegal=floss_prim_ilegal_area_v2-floss_prim_ilegal_area_v2_nbr
gen sample_assump=mayorallied-mayorallied_nbr
replace sample_assump=. if sample_assump<0

egen pairfe=group(coddane coddane_nbr)

reghdfe diff_ilegal sample_assump, abs(pairfe year) 
reghdfe diff_ilegal sample_assump if codepto==codepto_nbr, abs(pairfe year) 
reghdfe diff_ilegal sample_assump if carcode_master==carcode_master_nbr, abs(pairfe year) 
reghdfe diff_ilegal sample_assump if carcode_master==carcode_master_nbr & dmdn_politics2==1, abs(pairfe year) 
reghdfe diff_ilegal sample_assump if carcode_master==carcode_master_nbr & dmdn_politics2==0, abs(pairfe year)
