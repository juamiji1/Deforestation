...
* Maps
*
* REPLICATION PACKAGE: disabled. This block writes map_inputs.csv, which is
* consumed by external GIS software to draw the choropleth maps. Maps are out
* of scope for this package (see README.md). Producing no paper exhibit itself,
* the block is commented out so the package does not write into data/.
*-------------------------------------------------------------------------------
/*
preserve
