...
*-------------------------------------------------------------------------------
*Exporting results 
esttab r4 r5 r6 r7 r8 r9 using "${tables}/rdd_mechs_results.tex", keep(mayorallied) ///
...
prehead(`"\begin{tabular}{@{}l*{6}{c}}"' ///
            ...
            `" & Politicians are & Politicians are & Governor is head + & Governor is head + & Governor is head + & Governor not head + \\"' ///
            `" & majority & minority & No green party & Green party & Election year & Election year \\"' ///
            `" & (1) & (2) & (3) & (4) & (5) & (6) \\"'                       ///
            `" \toprule"')  ///
    postfoot(`" Dependent mean & ${mean_y4} & ${mean_y5} & ${mean_y6} & ${mean_y7} & ${mean_y8} & ${mean_y9} \\"' ///
	`" & & & & \\"' ///
	`" Bandwidth & ${ht} & ${ht} & ${ht} & ${ht} & ${ht} & ${ht} \\"' ///
	`" Polynomial & ${p} & ${p} & ${p} & ${p} & ${p} & ${p} \\"' ///
	`" Kernel & ${k} & ${k} & ${k} & ${k} & ${k} & ${k} \\"' ///
	`"\bottomrule \end{tabular}"') 

coefplot (r4, label(Politicians majority)) (r5, label(Politicians minority)) (r6, label("Governor is head + No green party")) ///
