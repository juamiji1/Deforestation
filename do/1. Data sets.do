...
*Deforestation by election period 
bys codmpio year_elections: egen elec_loss=sum(loss_km2)
gen elec_area00=elec_loss/area00
...
la var elec_loss "Forest loss in the election period (Km2)"
la var elec_area00 "Forest loss share in the election period (2000 base)"

save forestloss_00_18.dta, replace 


*-------------------------------------------------------------------------------
* 					4. Merging Elections & Deforestation data sets 
*
*-------------------------------------------------------------------------------
...
*merge m:1 codepto codmpio year using elections_forestloss_00_18.dta, keep(3) nogen            //NOTE: revisar codigos y numero de municipios para las bases de elecciones.
rename year_elections year 

sort codmpio year rank 

*Keeping elections with right or left parties in the race
keep if race_left==1 | race_right==1
...
merge 1:1 codmpio year using muni_generales.dta, keep(1 3) nogen keepus(indrural altura discapital disbogota)
